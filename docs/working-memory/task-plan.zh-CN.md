...
人类已提供：刘崇 / Chong Liu、独立研究者、ORCID `0009-0009-8116-1255`、无基金、无利益冲突。来源与对应英文措辞已保存在 `paper/submission/ethics-information-technology/TITLE_PAGE_METADATA_TEMPLATE.zh-CN.md` 和英文 mirror。

仍缺通讯作者身份、通讯邮箱、所需所在地字段、Author Contributions、Acknowledgements，以及实际界面要求的其他未提供事实。不能从姓名、ORCID 或连接账户猜填。元数据工作表不是 reviewer-facing 文件，live interface 尚未完成；本次事实补充不构成 submission / publication / release authorization。
...
1. 人类补全尚缺的通讯作者身份、通讯邮箱、所需城市 / 州或省 / 国家、Author Contributions、Acknowledgements 与实际界面要求的其他未提供事实；已提供的五项事实不重复请求，也不从身份信息推断剩余字段；
