...
- `WM-T034` — citation ↔ reference-list 双向一致性 validator：`IN PROGRESS / CI ENFORCED / LATEST-HEAD VERIFICATION PENDING`
...
1. 完成 masked/unmasked 双稿 citation ↔ reference-list CI 终检；
2. 人类/编辑部确认 masked reviewer route 并处理残余 deanonymization risk；
4. 决定 license；
