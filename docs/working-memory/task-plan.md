...
- `WM-T031` — EIT DOCX build + visual QA: `IN PROGRESS / TRACEABLE BUILD GENERATED / MASKED DUAL-BUILD CI PENDING / VISUAL QA PENDING`
...
- `WM-T034` — citation ↔ reference-list bidirectional validator: `IN PROGRESS / CI ENFORCED / LATEST-HEAD VERIFICATION PENDING`
...
1. complete masked/unmasked citation ↔ reference-list CI verification;
2. obtain human/editorial confirmation of the masked reviewer route and address residual deanonymization risk;
