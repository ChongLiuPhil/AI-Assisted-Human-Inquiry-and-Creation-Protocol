...
- [x] Define Working Argument Map.
- [x] Define Framework Approval Gate.
- [x] Define Final Artifact Approval Gate.
- [x] Define CONTENT / FORM / PROTOCOL routing.
- [x] Define evidence-conflict procedure.
- [x] Define agent handoff and memory scaling.
...
- [ ] Linter for unapproved framework changes.
