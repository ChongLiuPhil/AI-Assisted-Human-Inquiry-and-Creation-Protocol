...
研究或创作的目的、核心问题和方向由人类发起、给予并持续导航或批准。AI Agent 是协作工具，可以执行或辅助大量具体工作，但不承担项目目的与最终核心责任。

### 思想架构责任

主要锚定在人类批准的 framework。人类对其中实际呈现的全部实质内容承担理解、审核、判断与确认责任。

### 派生表达质量控制

AI 可以执行或辅助大量扩写、重组和表达工作；后续派生文本中的具体事实、证据、表达与实现缺陷仍需检查与修订。

### 公开学术问责

发布/投稿决定在适用外部标准要求的范围内仍属于人类责任，并由独立的 Final Artifact Approval Gate 处理。

可以压缩为：

> **HARC 以人类给予的项目目的与方向为上游，以人类充分理解并批准的 framework 作为核心思想责任的结构性锚点，并以 Final Artifact Approval 处理具体公开版本的发布问责。**
